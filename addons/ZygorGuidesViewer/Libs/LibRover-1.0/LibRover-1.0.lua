	...
	if Lib then
		...
		function LibRover:DebugNodes(n1,n2,...)
			...
			if n1 and n2 then
				...
				print(("Linkage: walk=%s,%s; fly=%s,%s; mode=%s"):format(walk and "YES" or "NO",walkwhy or "-",fly and "YES" or "NO",flywhy or "-",mode or "-")) --dry run
			else
		...
		function LibRover:DebugForcePath(...)
			if not ... then self.debug_forcepath=nil end
