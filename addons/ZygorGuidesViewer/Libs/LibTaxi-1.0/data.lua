...
data.taxipoints = {
	[1]={
		...
		['Silithus']={
					{name="Cenarion Hold",faction="A",npc="Cloud Skydancer",npcid=15177,x=54.4,y=32.7,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(609811) end},
					{name="Cenarion Hold",faction="H",npc="Runk Windtamer",npcid=15178,x=52.8,y=34.6,cond_fun=function() return ZGV.Parser.ConditionEnv.hasbuff(609811) end},
		},
		['Southern Barrens']={
	...
	[2]={
		...
		['Blasted Lands']={
					{name="Dreadmaul Hold",faction="H",npc="Preda",npcid=43121,x=43.7,y=14.3,cond_fun=function() return UnitLevel('player')<90 or ZGV.Parser.ConditionEnv.hasbuff(609811) end},
					{name="Nethergarde Keep",faction="A",npc="Alexandra Constantine",npcid=8609,x=61.3,y=21.6,cond_fun=function() return UnitLevel('player')<90 or ZGV.Parser.ConditionEnv.hasbuff(609811) end},
					{name="Sunveil Excursion",faction="H",npc="Salena",npcid=43114,x=50.9,y=72.9,cond_fun=function() return UnitLevel('player')<90 or ZGV.Parser.ConditionEnv.hasbuff(609811) end},
					{name="Surwich",faction="A",npc="Graham McAllister",npcid=43107,x=47.1,y=89.3,cond_fun=function() return UnitLevel('player')<90 or ZGV.Parser.ConditionEnv.hasbuff(609811) end},
					{name="Shattered Beachhead",faction="A",npc="Araazi",npcid=85731,x=67.6,y=28.0,cond_fun=function() return UnitLevel('player')>89 and not ZGV.Parser.ConditionEnv.hasbuff(609811) end},
					{name="Shattered Landing",faction="H",npc="Ameri Windblade",npcid=85734,x=72.9,y=48.6,cond_fun=function() return UnitLevel('player')>89 and not ZGV.Parser.ConditionEnv.hasbuff(609811) end},
		},
		['Burning Steppes']={
