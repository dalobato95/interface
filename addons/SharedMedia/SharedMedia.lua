...
LSM:Register(MediaType_FONT, "Homizio Black",				[[Interface\Addons\SharedMedia\fonts\homizio\black.ttf]])
LSM:Register(MediaType_FONT, "Homizio Bold",				[[Interface\Addons\SharedMedia\fonts\homizio\bold.ttf]])
LSM:Register(MediaType_FONT, "Homizio Light",				[[Interface\Addons\SharedMedia\fonts\homizio\light.ttf]])
LSM:Register(MediaType_FONT, "Homizio Medium",				[[Interface\Addons\SharedMedia\fonts\homizio\medium.ttf]])
LSM:Register(MediaType_FONT, "Homizio Regular",				[[Interface\Addons\SharedMedia\fonts\homizio\regular.ttf]])
LSM:Register(MediaType_FONT, "Homizio Thin",				[[Interface\Addons\SharedMedia\fonts\homizio\thin.ttf]])
